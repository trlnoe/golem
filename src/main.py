...
from data_loader import SyntheticDataset, ProteinSignalDataset, LoadDataset
...
def main():
    ...
    # Load dataset
    dataset = LoadDataset(args.n, args.d, args.graph_type, args.degree,
                               args.noise_type, args.B_scale,args.training_path, args.gt_path, args.seed)
